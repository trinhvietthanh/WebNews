...
<link href="/front-end/css/bootstrap-theme.min.css" rel="stylesheet" type="text/css" />
...
<div class="col-md-12 top" id="top">
    ...
    <div class="col-md-3">
    	...
    	<a href="#"><img src="/front-end/images/icon-twitter.png" /></a>
    	<a href="#"><img src="/front-end/images/icon-google.png" /></a>
    	<a href="#"><img src="/front-end/images/icon-insta.png" /></a>
    	<a href="#"><img src="/front-end/images/icon-pin.png" /></a>
    	<a href="#"><img src="/front-end/images/icon-youtube.png" /></a>
    </div>
</div>
...
<div class="col-md-12 brand">
    ...
    <div class="col-md-8">
    	<img src="/front-end/images/final-news-site_06.gif" width="100%" />
    </div>
</div>
...
<div class="wrapper">
	<div class="row">
		<div class="col-md-6">
    		<a href="#"><img src="/front-end/images/fireman-100722_1280-800x445.jpg" width="100%" /></a>
            <span class="caption">Lorem ipsum dolor sit amet</span>
    	</div>
    	<div class="col-md-6">
    		<div class="row">
        		<div class="col-md-6">
        	    	<a href="#"><img src="/front-end/images/bride-301814_1280-392x272.jpg" width="100%" height="162" /></a>
		            <span class="caption">Lorem ipsum dolor sit amet</span>
        	    </div>
        	    <div class="col-md-6">
        	    	<a href="#"><img src="/front-end/images/sea-418742_1920-392x272.jpg" width="100%" height="162" /></a>
		            <span class="caption">Lorem ipsum dolor sit amet</span>
        	    </div>
        	</div>
        	<div class="row" style="margin-top:30px;">
        		<div class="col-md-6">
        	    	<a href="#"><img src="/front-end/images/kayaking-569282_1280-392x272.jpg" width="100%" height="162" /></a>
		            <span class="caption">Lorem ipsum dolor sit amet</span>
        	    </div>
        	    <div class="col-md-6">
        	    	<a href="#"><img src="/front-end/images/clouds-sky-stadium-4516-392x272.jpg" width="100%" height="162" /></a>
                    <span class="caption">Lorem ipsum dolor sit amet</span>
        	    </div>
        	</div>        
    	</div>
    ...
    <div class="row" style="margin-top:30px;">
        ...
        <div class="col-md-12" style="border:1px solid #ccc; padding:15px 15px 30px 0px;">
        	...
        	<div class="col-md-6">
            	<img src="/front-end/images/coffee-563797_1280-390x205.jpg" width="100%" style="margin-bottom:15px;" />
            ...
            <div class="col-md-6">
            	<div class="row" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row">
    	            		<img src="/front-end/images/mosquito-542156_1280-392x272.jpg" width="100%" />
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                    	<div class="row">
         ...
         <div class="col-md-12" style="border:1px solid #ccc; padding:15px 15px 7px 15px; margin-top:30px;">
            ...
            <h3 style="border-bottom:3px solid #2b99ca; padding-bottom:5px;"><span style="padding:6px 12px; background:#2b99ca;">MORE NEWS</span></h3>
                ...
                <div class="col-md-12" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row">
    	            		<img src="/front-end/images/relaxed-498245_1280-392x272.jpg" width="100%" style="margin-left:-15px;" />
        	        	</div>
                    </div>
            	    <div class="col-md-8">
                    	<div class="row" style="padding-left:0px;">
...
<div class="col-md-12 bottom">
        ...
        <div class="col-md-4">
    		...
    		<a href="#"><img src="/front-end/images/icon-insta.png" /></a>
    		<a href="#"><img src="/front-end/images/icon-pin.png" /></a>
    		<a href="#"><img src="/front-end/images/icon-youtube.png" /></a><br />
